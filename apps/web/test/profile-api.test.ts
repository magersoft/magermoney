...
const profile = { id: '11111111-1111-4111-8111-111111111111', displayName: null, locale: 'ru', defaultCurrency: 'EUR', reportingCurrencies: ['EUR', 'USD'], onboardingCompletedAt: null };
describe('profileApi', () => {
